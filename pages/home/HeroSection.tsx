...
export default function Hero() {
  return (
    <section className="hero relative flex flex-col md:flex-row min-h-screen w-full overflow-hidden bg-off-white-500">
      {/* Left: Content */}
      <div className="relative z-10 flex flex-col justify-center items-start w-full md:w-1/2 py-12 md:pl-20 pt-20 md:pt-6 px-6 py-12 md:py-24">
        <p className="text-sm font-semibold text-field-green-500 mb-2 uppercase tracking-wider">Step Inside the Clubhouse</p>
        <h1 className="text-left text-4xl font-bold tracking-tighter text-field-green-500 md:text-6xl">
          Built for<br />
          <TypewriterEffect
